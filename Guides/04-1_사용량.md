...
- 스텝페이 포탈 또는 [V1 API](https://docs.steppay.kr/reference/createproduct)를 통해 사용량 상품을 생성합니다.
    <details>
    <summary>사용량 상품 생성하기</summary>
    <div markdown="1">
    ```bash
    curl --request POST \
...
- 스텝페이 포탈 또는 [V1 API](https://docs.steppay.kr/reference/getproductprice)를 통해 가격 플랜을 생성합니다.
    <details>
    <summary>고정 요금 템플릿 상품 생성하기</summary>
    <div markdown="1">
    ```bash
    curl --request POST \
    ...
    <details>
    <summary>건당 과금 템플릿 상품 생성하기</summary>
    <div markdown="1">
    ```bash
    curl --request POST \
         --url https://api.steppay.kr/api/v1/products/{상품번호}/prices \
...
- 스텝페이 포탈 또는 [V1 API](https://docs.steppay.kr/reference/createinvoice) 통해 청구서를 발송합니다.
    <details>
    <summary>사용량 상품 청구서 발송</summary>
    <div markdown="1">
    ```bash
    curl --request POST \
         --url 'https://api.steppay.kr/api/v1/invoices?temporary=false' \
         --header 'Secret-Token: {인증토}' \
         --header 'content-type: application/json' \
         --data '
    {
      "items": [
...
![range_template.png](../images/04_가격플랜/04-1_사용량/range_template.png)
...
![range_template_example.png](../images/04_가격플랜/04-1_사용량/count_template.png)
