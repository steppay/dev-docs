...
- 스텝페이 포탈 또는 [V1 API](https://docs.steppay.kr/reference/createproduct)를 통해 1개 이상의 상품을 생성합니다.
- 스텝페이 포탈 또는 [V1 API](https://docs.steppay.kr/reference/getproductprice)를 통해 가격 플랜을 생성합니다.
...
1. 바로 구매하기
   상품에서 '바로 구매' 버튼을 클락하여 결제 화면으로 이동하면 주문이 생성됩니다.
   ![mystore_product.png](../images/05_주문/mystore_product.png)
2. 장바구니에서 구매하기
   상품을 장바구니에 담고 '결제 진행' 버튼을 클락하여 결제 화면으로 이동하면 주문이 생성됩니다.
