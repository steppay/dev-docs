...
2. 아래와 같이 필수 필드에 값을 채우고 추가 버튼 클릭합니다.
   ...
   ![create_customer.png](https://docs-image-translator-qpz5cerjg-steppay.vercel.app/api/localize?dir=02_customer&name=create_customer.png)
...
3. 아래와 같이 고객 정보에 대한 엑셀 파일을 업로드하여 고객을 추가합니다.
   ...
   ![create_customer_excel.png](https://docs-image-translator-qpz5cerjg-steppay.vercel.app/api/localize?dir=02_customer&name=create_customer_excel.png)
...
2. 아래와 같이 커스텀 필드들을 자유롭게 설정합니다.
   ...
   ![custom_field.png](https://docs-image-translator-qpz5cerjg-steppay.vercel.app/api/localize?dir=02_customer&name=customer_custom_field.png)
