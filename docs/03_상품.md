...
- V1 API를 통해 무료 체험을 적용하기 위해서는 `enabledDemo` 필드를 ‘true’로 지정 한 후 `demoPeriod`(체험 기간) `demoPeriodUnit`(체험 기간 단위)를 적절하게 입력합니다. 👉 [무료체험 상품 만들어보기](https://docs.develop.steppay.kr/docs/usecase/zwbjqhmqp15sy-#%EC%9C%A0%ED%8A%9C%EB%B8%8C-%EC%9A%94%EA%B8%88%EC%A0%9C)
