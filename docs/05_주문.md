...
[결제창 연동 가이드](https://docs.develop.steppay.kr/docs/guide/ulwq2kcokkbf0-managed#1-redirection)를 참고하여 결제 링크 방식 또는 결제창 연동을 통해 결제를 받고 파라미터로 전달된 Url로 리다이렉트 시킬 수 있습니다.