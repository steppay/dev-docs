...
웹훅이란 스텝페이에서 발생하는 정보를 실시간으로 알려주는 기능입니다. 다양한 [스텝페이 이벤트](https://steppay.stoplight.io/docs/guide/eo1f40yz545ad-webhook-events)를 제공하고 있으며 원하는 이벤트만 연동하여 수신받으실 수 있습니다.
...
#### `STEP 1` 
- 웹훅을 수신 받을 end-point를 준비합니다. 수신받으실 데이터는 [Api Spec](https://steppay.stoplight.io/docs/guide/har8c97gh696g-webhook-v2#api-spec)를 참조해주세요.
