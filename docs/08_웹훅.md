...
<img src="https://docs-image-translator-qpz5cerjg-steppay.vercel.app/api/localize?dir=08_webhook&name=webhook_1.png" width="60%" style="display: block; margin: 0 auto; transition: none;">
...
| 웹훅 버전                                                       | 출시         | 최신 업데이트 |
| :---------------------------------------------------------- | :--------- | :------ |
| [웹훅 v2](https://steppay.stoplight.io/docs/guide/har8c97gh696g-webhook-v2) | 2023/07/31 | -       |
| [웹훅 v1](https://steppay.stoplight.io/docs/guide/b64e9ivabnonj-webhook-v1) | -          | -       |**