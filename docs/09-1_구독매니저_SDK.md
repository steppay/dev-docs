...
![subscription_sdk_list.png](https://docs-image-translator-qpz5cerjg-steppay.vercel.app/api/localize?dir=09_SDKs&name=subscription_sdk_list.png)
...
- 스텝페이 포탈에서 [설정 → 구독 매니저 → SDK]에서 Embed Code를 확인합니다. 
  ...
  ![구독매니저 SDK 적용 예시 이미지](https://docs-image-translator-qpz5cerjg-steppay.vercel.app/api/localize?dir=09_SDKs&name=setting_sdk.png)
